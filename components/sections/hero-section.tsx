                    ...
                    >
                        <div className="relative">
                            <Button
                                ...
                                asChild
                            >
                                <a href={primaryCta.href} className="gap-1">
                                    {primaryCta.label}
                                    <ChevronRight className="w-4 h-4" />
                                </a>
                            </Button>
                            <div className="absolute -top-8 -left-20 hidden md:block">
                                <HandArrow
                        ...
                        {secondaryCta && (
                            <Button
                                variant="ghost"
                                size="lg"
                                className="rounded-full px-8 py-6 text-base text-foreground/80 hover:text-foreground hover:bg-muted/60 gap-2"
                                asChild
                            >
