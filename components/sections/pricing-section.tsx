  ...
  return (
    <section id="pricing" className="relative w-full bg-background py-24 md:py-32 overflow-visible">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center px-6 text-center">
        ...
        <motion.h2
          className="mt-4 text-5xl font-semibold tracking-tight leading-[1.05] text-gray-900 sm:text-6xl lg:text-7xl font-sans [text-wrap:balance] [&_em]:font-[family-name:var(--font-display)] [&_em]:italic [&_em]:font-medium [&_em]:text-gray-800"
        ...
        <div className="mt-14 grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {pricingPlans.map((plan, index) => (
            <GlassCard
              ...
              className={cn(
                "flex min-h-[22rem] md:min-h-[26rem] flex-col rounded-3xl border px-8 py-9 text-left",
            ...
            >
              ...
              <div className="mt-8 min-h-[92px]">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-[42px] font-semibold tracking-[-0.03em] text-gray-900">
                    {plan.price}
                  </span>
              ...
              <div className="mt-auto pt-10">
                <button
                  className={cn(
                    "w-full rounded-full px-5 py-3.5 text-[13px] font-semibold tracking-[-0.01em] transition-all duration-200 cursor-pointer",
                    plan.highlight
